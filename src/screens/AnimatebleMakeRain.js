...
import erlich from './../assets/images/erlich.png'
import moneyFront from './../assets/images/money-front.png'
...
const AnimatebleMakeRain = ({count = 15, duration = 3000}) => (
  <ErlichBachman>
    {range(count)
...
export default AnimatebleMakeRain
